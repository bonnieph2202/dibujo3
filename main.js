...
document.getElementById('sketch_name').innerHTML = 'Dibujo a realizar: ' + sketch;
...
function draw() {
  // Establece stroke weight en 10
  strokeWeight(11);
  // Establece stroke color a black
  stroke(0);
  // Si el mouse está presionado, dibujar una línea entre la posición anteiror y actual.
  if (mouseIsPressed) {
